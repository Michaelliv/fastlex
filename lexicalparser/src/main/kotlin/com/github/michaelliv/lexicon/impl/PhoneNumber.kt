...
val DEFAULT_COUNTRY_CODES = hashSetOf(
    "93",
    "355",
    "213",
    "1-684",
...
class PhoneNumber(
    areaCodes: Collection<String> = DEFAULT_COUNTRY_CODES
) : Lexicon {
    override val name: String = PHONE_NUMBER
    override val overrides: Array<Lexicon> = BASE_LEXICON concat LikeNumber()
    private val areaCodesTrie = Trie.from(areaCodes)
